export const PROPERTY_TYPES = [
  { key: 'apartment', label: 'Apartment', icon: 'fa-building' },
  { key: 'villa', label: 'Villa', icon: 'fa-home' },
  { key: 'house', label: 'House', icon: 'fa-house' },
  { key: 'duplex', label: 'Duplex', icon: 'fa-layer-group' },
  { key: 'penthouse', label: 'Penthouse', icon: 'fa-crown' },
  { key: 'studio', label: 'Studio', icon: 'fa-square' },
  { key: 'townhouse', label: 'Townhouse', icon: 'fa-city' },
  { key: 'chalet', label: 'Chalet', icon: 'fa-mountain' },
  { key: 'office', label: 'Office', icon: 'fa-briefcase' },
  { key: 'shop', label: 'Shop', icon: 'fa-store' },
  { key: 'warehouse', label: 'Warehouse', icon: 'fa-warehouse' },
  { key: 'land', label: 'Land', icon: 'fa-map' }
];
